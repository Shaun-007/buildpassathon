...
export default function SecurityScanner() {
  ...
  const handleRecord = async (action) => {
    ...
    try {
      ...
      // ENTRY completes the pass, so remove the pass container.
      if (action === 'ENTRY') {
        setVerificationResult(null);
      } else {
        // Keep the container after EXIT so ENTRY can be recorded.
        setVerificationResult(data);
      }
              ...
              <>
                ...
                <div style={{ display: 'flex', gap: 12 }}>
                  <button
                    ...
                    disabled={
                      recordingAction ||
                      verificationResult.lastAction === 'EXIT' ||
                      verificationResult.lastAction === 'ENTRY'
                    }
